...
public class Fragment_Inspection extends Fragment implements View.OnClickListener, RadioGroup.OnCheckedChangeListener,
    ...
    Bitmap myBitmap;
    Uri picUri;
    private String mModelName=null,mInspectionName=null,mRemarks =null,mTested=null,mImageData = null;
    ...
    private void submitData() {
        ...
        if(mModelName!=null){
            if(mInspectionName!=null){
                if(mTested!=null){
                    InspectionEntity inspectionEntity = new InspectionEntity(mInspectionName,mModelName,mTested,mRemarks,mImageData);
